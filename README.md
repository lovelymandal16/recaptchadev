...
## Environments
- Preview: https://main--recaptchadev--lovelymandal16.hlx.page/
- Live: https://main--recaptchadev--lovelymandal16.hlx.live/
...
1. Open the `recaptchadev` directory in your favorite IDE and start coding :)
